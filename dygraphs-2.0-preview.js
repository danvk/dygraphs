...
tarp:new utils.IFrameTarp(), // contextB is the same thing as this context object but renamed.
...
var i;var ctx=this.canvas_ctx_;if(this.getOption('highlightSeriesOpts')){ctx.clearRect(0,0,this.width_,this.height_);var alpha=1.0 - this.getNumericOption('highlightSeriesBackgroundAlpha');if(alpha){ // Activating background fade includes an animation effect for a gradual
...
this.animateSelection_(1);return;}alpha *= opt_animFraction;}ctx.fillStyle = 'rgba(255,255,255,' + alpha + ')';ctx.fillRect(0,0,this.width_,this.height_);} // Redraw only the highlighted series in the interactive canvas (not the
...
},{"../dygraph-utils":16}],23:[function(require,module,exports){
/**
 * @license
...
},{"../dygraph-interaction-model":11,"../dygraph-utils":16}]},{},[17])(17)
});
