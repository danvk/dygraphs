...
describe("callback", function () {
     ...
     *
     */
    it("should highlight when highlight callback is called", function () {
        var h_row;
        var h_pts;
     ...
     */
    it("should not call drawPointCallback when drawPoints is false", function () {
        var called = false;
     ...
     */
    it("should call drawPointCallback when drawPoints is true", function () {
        var called = false;
    ...
    it("should call drawPointCallback with point size", function () {
        var pointSize = 0;
        var count = 0;
     ...
     */
    it("should call drawPointCallback for isolated points", function () {
        var xvalues = [];
     ...
     *
     */
    it("should call drawHighlightPointCallback", function () {
        var called = false;
     ...
     */
    it("should highlight for basic closest-point", function () {
     ...
     */
    it("should set selection with series name", function () {
     ...
     */
    it("should highlight for closest-point with stacked graph", function () {
     ...
     */
    it("should call closestPointCallback css 1", function () {
     ...
     */
    it("should testClosestPointCallbackCss2", function () {
     ...
     */
    it("underlayCallback_noSeries", function () {
        var called = false;
        var yMin, yMax;
     ...
     */
    it("underlayCallback_yAxisRange", function () {
        var called = false;
        var yMin, yMax;
