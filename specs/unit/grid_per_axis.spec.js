...
describe("grid-per-axis", function () {
    ...
    it("testPerAxisGridColor", function () {
        var opts = {
            width: 480,
            height: 320,
            errorBars: false,
        ...
        for (var axis = 0; axis < 2; axis++) {
            ...
            for (var i = 0; i < gridlines[axis].length; i++) {
                ...
                assert.deepEqual(gridColors[axis], Util.samplePixel(g.hidden_, x, y), "Unexpected grid color found at pixel: x: " + x + "y: " + y);
            }
        }
    });
    ...
    it("testPerAxisGridWidth", function () {
        ...
        for (var i = 0; i < xGridlines.length; i++) {
            ...
            assert.deepEqual(emptyColor, Util.samplePixel(g.hidden_, x - 4, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(gridColor, Util.samplePixel(g.hidden_, x - 3, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(gridColor, Util.samplePixel(g.hidden_, x - 2, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(gridColor, Util.samplePixel(g.hidden_, x - 1, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(gridColor, Util.samplePixel(g.hidden_, x, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(gridColor, Util.samplePixel(g.hidden_, x + 1, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
            assert.deepEqual(emptyColor, Util.samplePixel(g.hidden_, x + 2, y).slice(0, 3), "Unexpected x-grid color found at pixel: x: " + x + "y: " + y);
        }
    });
