...
describe("annotations", function () {
    ...
    it("should draw annotations", function () {
        var opts = {
            width: 480,
            height: 320
        };
    ...
    it("should keep annotations on resize", function () {
        var opts = {};
        var data = "X,Y\n" +
                "0,-1\n" +
                "1,0\n" +
    ...
    it("should not annotate out of x range", function () {
        var opts = {};
        var data = "X,Y\n" +
                "0,-1\n" +
                "1,0\n" +
    ...
    it("should not annotate out of y range", function () {
        var opts = {};
        var data = "X,Y\n" +
                "0,-1\n" +
                "1,0\n" +
    ...
    it("should draw in draw callback", function () {
        var data = "X,Y\n" +
            "0,-1\n" +
            "1,0\n" +
            "2,1\n";
    ...
    it("should stack annotations", function () {
        var data = 'X,Y1,Y2\n' +
            '0,1,2\n' +
            '1,2,3\n';
        var graph = document.getElementById("graph");
