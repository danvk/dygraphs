...
describe("axis-labels", function () {
    ...
    it("should subtract one to one", function () {
        var opts = {
            width: 480,
            height: 320
        };
        ...
        g.setSelection(0);
        assert.deepEqual('0: Y: -1', Util.getLegend());
    });

    it("should handle range near zero", function () {
        var opts = {
            drawAxesAtZero: true,
            width: 480,
            height: 320
    ...
    it("should handle small range away from zero", function () {
        var opts = {
            width: 480,
            height: 320
        };
    ...
    it("should format x axis time label properly", function () {
        var opts = {
            width: 480,
            height: 320
        };
    ...
    it("should format axis label", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("should format date axis label", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("should format date value", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("should use precedent for axis label formatter", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    // one-by-one.
    it("should increment with label formatter", function () {
        var opts = {
            width: 480,
            height: 320,
            labels: ['x', 'y']
    ...
    it("should format globally", function () {
        var opts = {
            width: 480,
            height: 320,
            labels: ['x', 'y'],
    ...
    it("should format values with parameters", function () {
        var calls = [];
    ...
    it("should order the series", function () {
        var opts = {
            width: 480,
            height: 320
        };
    ...
    it("should label KMG2 top", function () {
        var data = [];
        data.push([0, 0]);
        data.push([1, 2000]);
        data.push([2, 1000]);
     ...
     */
    it("should work with log scale", function () {
        var g = new Dygraph("graph", [[0, 5], [1, 1000]], {logscale: true});
        var nonEmptyLabels = Util.getYLabels().filter(function (x) {
            return x.length > 0;
        });
     ...
     */
    it("should include zero", function () {
    ...
    it("should label axis with different font size", function () {
        var graph = document.getElementById("graph");
    ...
    it("should label axis with font size null", function () {
        var graph = document.getElementById("graph");
        var g = new Dygraph(graph, simpleData,
            {
                axisLabelFontSize: null
    ...
    it("should label axis with different color", function () {
        var graph = document.getElementById("graph");
        var g = new Dygraph(graph, simpleData, {});
    ...
    it("should label axis with null color", function () {
        var graph = document.getElementById("graph");
        var g = new Dygraph(graph, simpleData,
            {
                axisLabelColor: null
     ...
     */
    it("should override KMB label formatter", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "X,a,b\n" +
            "1,0,2000\n" +
     ...
     */
    it("should lable KMB per axis", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "x,a,b\n" +
            "1000,0,2000\n" +
     ...
     */
    it("should label KMBG2I per axis", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "x,a,b\n" +
            "1000,0,2000\n" +
     ...
     */
    it("should override sig figs on each axis", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "x,a,b\n" +
            "1000,0,2000\n" +
     ...
     */
    it("should display proper digits after decimal on each axis", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "x,a,b\n" +
            "0.006,0.001,0.008\n" +
     ...
     * This test shows you can override digitsAfterDecimal on the axis level.
     */
    it("should respect max number width per axis", function () {
        var g = new Dygraph(
            document.getElementById("graph"),
            "x,a,b\n" +
            "12401,12601,12804\n" +
