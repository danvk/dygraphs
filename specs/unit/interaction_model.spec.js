...
describe("interaction-model", function () {
    ...
    var pan = function (g, xRange, yRange) {
        ...
        assert.equalDelta(xRange, g.xAxisRange(), 0.2);
        // assert.equalDelta(originalYRange, g.yAxisRange(0), 0.2); // Not true, it's something in the middle.
        ...
        assert.equalDelta(xRange, g.xAxisRange(), 0.2);
        assert.equalDelta(yRange, g.yAxisRange(0), 0.2);
    };
     ...
     */
    it("testClickCallbackIsCalle", function () {
        var clicked;
     ...
     */
    it("testPointClickCallbackCalledPriorToClickCallbac", function () {
        var counter = 0;
        var pointClicked;
        var clicked;
        var g = new Dygraph(document.getElementById("graph"), data2, {
