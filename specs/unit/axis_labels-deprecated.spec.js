...
describe("axis-labels-deprecated", function () {
    ...
    it("DEPRECATED: should format time label xaxis", function () {
        var opts = {
            width: 480,
            height: 320
        };
    ...
    it("DEPRECATED: should format label axis", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("DEPRECATED: should format date axis label", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    // labels.
    it("DEPRECATED: should format the value", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("DEPRECATED: should format the date value", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    it("DEPRECATED: should format axis label with correct precedence", function () {
        var opts = {
            width: 480,
            height: 320,
            axes: {
    ...
    // one-by-one.
    it("DEPRECATED: should format label axis incrementally", function () {
        var opts = {
            width: 480,
            height: 320,
            labels: ['x', 'y']
